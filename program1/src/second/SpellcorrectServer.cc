...
SpellcorrectServer::SpellcorrectServer(const Configuration & conf)
:Server(conf.getConfig("ip"),
		atoi(conf.getConfig("port").c_str()),
		atoi(conf.getConfig("listenFdNum").c_str()),
		atoi(conf.getConfig("pthreadNum").c_str()),
		atoi(conf.getConfig("taskQueueSize").c_str())){
}
